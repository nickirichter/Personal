...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Nicki's Awesome GUI")
...
class MainWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.textLabel = QLabel("How would you describe this GUI?")
        self.textLabel.setFont(self.boldFont)

        # Create the push buttons
        self.oneCheckBox = QCheckBox("Stellar")
        self.twoCheckBox = QCheckBox("Incredible")
        self.threeCheckBox = QCheckBox("Magnificent")
        self.fourCheckBox = QCheckBox("Extraordinary")
        self.closePushButton = QPushButton("Close")

        # Add buttons one and two to the button layout
        self.buttonLayout.addWidget(self.oneCheckBox)
        self.buttonLayout.addWidget(self.twoCheckBox)
        self.buttonLayout.addWidget(self.threeCheckBox)
        self.buttonLayout.addWidget(self.fourCheckBox)
        ...
        #self.mainLayout.addWidget(self.threeCheckBox)
        self.mainLayout.addStretch(0)
